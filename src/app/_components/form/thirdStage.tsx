      ...
      <div className='mt-16 flex flex-col items-center'>
        ...
        <div className='mt-8 flex flex-row'>
          <div className='flex flex-col justify-center justify-items-end gap-10'>
            <button className='w-[185] p-2 font-display text-[14px] font-light text-black border-1 border-black rounded-md' onClick={()=> props.onOptionSelected('A')}>Sim</button>
            <button className='w-[185] p-2 font-display text-[14px] font-light text-black border-1 border-black rounded-md' onClick={()=> props.onOptionSelected('B')}>Não</button>
          </div>
          <Image src={'/mapa.png'} alt={'Mapa'} width={350} height={350} />
        </div>
